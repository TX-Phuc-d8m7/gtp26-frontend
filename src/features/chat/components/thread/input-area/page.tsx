...
import { InputAreaProps, styles } from ".";
...
export default function InputArea({
  ...
  const quickPrompts = [
    {
      prompt: "Gợi ý bữa tối nhẹ bụng",
      label: "Bữa tối thanh đạm",
      meta: "Ít dầu mỡ",
      icon: Clock3,
      color: "#ea580c",
    },
    {
      prompt: "Gợi ý món ăn cho người bị dị ứng sữa bò",
      label: "An toàn",
      meta: "Không chứa sữa / phô mai",
      icon: Leaf,
      color: "#16a34a",
    },
    {
      prompt: "Tìm món phù hợp cho người đang bị béo phì",
      label: "Giảm cân",
      meta: "Ít calo, không béo ngậy",
      icon: Flame,
      color: "#dc2626",
    },
  ];
