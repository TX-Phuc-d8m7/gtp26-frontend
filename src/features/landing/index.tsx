...
export function LandingPage() {
  ...
  useRedirectIfLoggedIn();
  const goToEntryRoute = () => router.push(getLandingEntryRoute());

  return (
    <div
      className="min-h-screen bg-warm font-sans antialiased"
      style={{ color: "#1c1917" }}
    >
      {/* ── NAVBAR ─────────────────────────────────────────────────────────── */}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-6 items-center py-16 lg:py-24">
            ...
            <div className="flex flex-col gap-6 lg:pr-8">
              ...
              >
                Bữa ăn ngon <span className="text-gradient">mỗi ngày,</span>
                <br />
                không còn{" "}
      ...
      <section id="huong-dan" className="py-24 max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg,transparent,#fed7aa,transparent)",
            }}
          />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex flex-col gap-8">
              <FadeIn>
                ...
                >
                  Không chỉ gợi ý món — chúng tôi giúp bạn lên kế hoạch, nấu
                  ngon và ăn lành mạnh hơn.
                </p>
              </FadeIn>
                ...
                {[
                  {
                    ...
                    title: "Theo thời tiết",
                    desc: "Gợi ý món phù hợp với thời tiết thực tế hôm nay",
                    color: "#eff6ff",
                    ic: "#2563eb",
                  },
                  {
                    ...
                    desc: "Cân bằng calorie, đạm, tinh bột theo nhu cầu cơ thể",
                    color: "#f0fdf4",
                    ic: "#16a34a",
                  },
                  {
                    ...
                    desc: "Lên kế hoạch 7 ngày với danh sách mua sắm tự động",
                    color: "#fff3e8",
                    ic: "#f97316",
                  },
                  {
                    ...
                    desc: "Hướng dẫn từng bước với hình ảnh minh họa rõ ràng",
                    color: "#fef3c7",
                    ic: "#d97706",
                  },
                  {
                    ...
                    desc: "Tự động tính nguyên liệu theo số người ăn",
                    color: "#fdf4ff",
                    ic: "#9333ea",
                  },
                  {
            ...
            <FadeIn delay={0.2}>
              <div className="relative h-[580px] rounded-3xl overflow-hidden shadow-2xl shadow-stone-200">
                <Image
                  src={IMG.feature}
                  alt="Nguyên liệu nấu ăn tươi ngon"
                  fill
                  className="object-cover"
                />
                <div
        ...
        <div className="max-w-4xl mx-auto px-5 sm:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              {
                quote:
                  "Từ ngày dùng app này tôi không còn phải hỏi 'hôm nay ăn gì' nữa. AI gợi ý đúng với khẩu vị đến lạ!",
                name: "Nguyễn Thị Lan",
                role: "Nội trợ · Hà Nội",
                stars: 5,
              },
              {
                quote:
                  "Tính năng thực đơn cả tuần giúp tôi tiết kiệm được rất nhiều thời gian mua sắm và nấu nướng.",
                name: "Trần Minh Tuấn",
              ...
              {
                quote:
                  "Công thức nấu chi tiết, dễ làm theo. Con tôi thích ăn hơn vì được chọn món theo sở thích.",
                name: "Lê Thị Hồng",
        ...
        <FadeIn>
          <div className="relative rounded-3xl lg:rounded-[2.5rem] overflow-hidden text-white text-center py-20 px-6">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg,#7c3aed 0%,#dc2626 45%,#ea580c 100%)",
              }}
            />
            <div
            ...
            <div className="relative">
              ...
              <p className="text-lg text-white/80 mb-10 max-w-lg mx-auto">
                Để AI gợi ý cho bạn món ngon nhất — phù hợp với khẩu vị, thời
                tiết và sức khỏe của bạn.
              </p>
              <motion.button
                onClick={goToEntryRoute}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            ...
            {[
              ...
              {
                title: "Hỗ trợ",
                links: ["Về chúng tôi", "Hướng dẫn", "Liên hệ", "Phản hồi"],
              },
            ].map((col) => (
              <div key={col.title}>
                <div
